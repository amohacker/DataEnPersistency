...
private ProductDAO pdao;
    public Test(ReizigerDAO rdao, AdresDAO adao, OVChipkaartDAO odao, ProductDAO pdao) {
        this.rdao = rdao;
        this.adao = adao;
        this.odao = odao;
    }
    ...
    public void testAdresDAO() throws SQLException {
        ...
        Reiziger ben = new Reiziger(83, "B", "", "Paprika", Date.valueOf(gbdatum));
        Adres huis = new Adres(59, "52AQ", "51", "Janstraat", "Pietersburg");
        ben.setAdres(huis);
    ...
    public void testProductDAO() throws SQLException {

        Product product = new Product(189021, "Testkorting", "testbeschrijving", 6.9f);
        pdao.save(product);
    }
}
