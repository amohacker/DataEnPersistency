...
values (7369, 'S02', '2022-3-2', 'LEERDAM')
...
(mnr, naam, voorl, functie, gbdatum, chef, maandsal, comm, afd)
VALUES(8123, 'Jansen', 'J', 'STAGIAIR', '2000-12-22', 7566, 200.00, NULL, 20)
ON CONFLICT DO NOTHING;                                                                                         -- [TEST]
...
values ('D&P', '2021-11-1', 'LEERDAM')
ON CONFLICT DO NOTHING;                                                                                         -- [TEST]
insert into uitvoeringen (cursus, begindatum, locatie)
values ('D&P', '2022-4-1', 'LEERDAM')
ON CONFLICT DO NOTHING;                                                                                         -- [TEST]
INSERT INTO inschrijvingen
(cursist, cursus, begindatum)
VALUES(7566, 'D&P', '2021-11-01')
ON CONFLICT DO NOTHING;                                                                                         -- [TEST]
INSERT INTO inschrijvingen
(cursist, cursus, begindatum)
VALUES(7876, 'D&P', '2022-4-1')
ON CONFLICT DO NOTHING;                                                                                         -- [TEST]
INSERT INTO inschrijvingen
(cursist, cursus, begindatum)
VALUES(7902, 'D&P', '2022-4-1')
ON CONFLICT DO NOTHING;                                                                                         -- [TEST]
...
--Omdat alders staat ingeschreven bij een cursus zou dit de foreign key restraint breken
...
insert into medewerkers (mnr, naam, voorl, chef, gbdatum , maandsal, afd, functie )
values (8531, 'Koeman', 'J', '7839', '2000-12-1', '7650', 50, 'MANAGER')
ON CONFLICT DO NOTHING;                                                                                         -- [TEST]
